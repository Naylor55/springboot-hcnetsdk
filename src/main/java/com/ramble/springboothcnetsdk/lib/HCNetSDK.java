...
//智能设备类型
    ...
    /////////////////////////////////////////////////////////////////////////
    //校时结构参数
    public static class NET_DVR_TIME extends SdkStructure {//校时结构参数
        public int dwYear;        //年
    ...
    public static class NET_DVR_HANDLEEXCEPTION_V30 extends SdkStructure {
    ...
    //报警和异常处理结构(子结构)(多处使用)
    public static class NET_DVR_HANDLEEXCEPTION extends SdkStructure {
        public int dwHandleType;            /*处理方式,处理方式的"或"结果*//*0x00: 无响应*//*0x01: 监视器上警告*//*0x02: 声音警告*//*0x04: 上传中心*/    /*0x08: 触发报警输出*//*0x20: 触发抓图*/  //(JPEG定制)
    ...
    //DVR设备参数
    public static class NET_DVR_DEVICECFG extends SdkStructure {
        public int dwSize;
    ...
    //DVR设备参数
    public static class NET_DVR_DEVICECFG_V40 extends SdkStructure {
        public int dwSize;
        public byte[] sDVRName = new byte[NAME_LEN];     //DVR名称
        public int dwDVRID;                //DVR ID,用于遥控器 //V1.4(0-99), V1.5(0-255)
        public int dwRecycleRecord;        //是否循环录像,0:不是; 1:是
    ...
    public static class NET_DVR_IPADDR extends SdkStructure {
    ...
    //网络数据结构(子结构)(9000扩展)
    public static class NET_DVR_ETHERNET_V30 extends SdkStructure {
    ...
    public static class NET_DVR_ETHERNET extends SdkStructure {//网络数据结构(子结构)
    ...
    public static class NET_DVR_PPPOECFG extends SdkStructure {//PPPoe
        public int dwPPPoE;
    ...
    public static class NET_DVR_NETCFG_V30 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_NETCFG extends SdkStructure {//网络配置结构
        public int dwSize;
    ...
    //通道图象结构
    public static class NET_DVR_SCHEDTIMEWEEK extends SdkStructure {
        public NET_DVR_SCHEDTIME[] struAlarmTime = new NET_DVR_SCHEDTIME[8];


    }

    public static class byte96 extends SdkStructure {
        public byte[] byMotionScope = new byte[96];


    }

    public static class NET_DVR_MOTION_V30 extends SdkStructure {//移动侦测(子结构)(9000扩展)
    ...
    public static class NET_DVR_MOTION extends SdkStructure {//移动侦测(子结构)
    ...
    public static class NET_DVR_HIDEALARM_V30 extends SdkStructure {//遮挡报警
    ...
    public static class NET_DVR_HIDEALARM extends SdkStructure {//遮挡报警(子结构)  区域大小704*576
        public int dwEnableHideAlarm;                /* 是否启动遮挡报警 ,0-否,1-低灵敏度 2-中灵敏度 3-高灵敏度*/
        public short wHideAlarmAreaTopLeftX;            /* 遮挡区域的x坐标 */
        public short wHideAlarmAreaTopLeftY;            /* 遮挡区域的y坐标 */
        public short wHideAlarmAreaWidth;                /* 遮挡区域的宽 */
    ...
    public static class NET_DVR_VILOST_V30 extends SdkStructure {    //信号丢失报警(子结构)(9000扩展)
    ...
    public static class NET_DVR_VILOST extends SdkStructure {    //信号丢失报警(子结构)
        public byte byEnableHandleVILost;    /* 是否处理信号丢失报警 */
        public NET_DVR_HANDLEEXCEPTION strVILostHandleType;    /* 处理方式 */

    }

    public static class NET_DVR_SHELTER extends SdkStructure {  //遮挡区域(子结构)
    ...
    public static class NET_DVR_COLOR extends SdkStructure {
    ...
    public static class NET_DVR_VICOLOR extends SdkStructure {
    ...
    //信号丢失
    public static class NET_DVR_VILOST_V40 extends SdkStructure {
    ...
    public static class NET_DVR_DNMODE extends SdkStructure {
    ...
    public static class NET_DVR_MOTION_MULTI_AREAPARAM extends SdkStructure {
    ...
    public static class NET_DVR_MOTION_MULTI_AREA extends SdkStructure {
    ...
    public static class NET_DVR_MOTION_SINGLE_AREA extends SdkStructure {
    ...
    public static class NET_DVR_MOTION_MODE_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_MOTION_V40 extends SdkStructure {
    ...
    public static class NET_DVR_RGB_COLOR extends SdkStructure {
    ...
    public static class NET_DVR_HIDEALARM_V40 extends SdkStructure {
        public int dwEnableHideAlarm;                /* 是否启动遮挡报警，0-否，1-低灵敏度，2-中灵敏度，3-高灵敏度*/
        public short wHideAlarmAreaTopLeftX;            /* 遮挡区域的x坐标 */
        public short wHideAlarmAreaTopLeftY;            /* 遮挡区域的y坐标 */
        public short wHideAlarmAreaWidth;                /* 遮挡区域的宽 */
    ...
    public static class NET_DVR_PICCFG_V40 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_PICCFG_V30 extends SdkStructure {
        public int dwSize;
        public byte[] sChanName = new byte[NAME_LEN];
        public int dwVideoFormat;                /* 只读 视频制式 1-NTSC 2-PAL*/
    ...
    public static class NET_DVR_PICCFG_EX extends SdkStructure {//通道图象结构SDK_V14扩展
        public int dwSize;
        public byte[] sChanName = new byte[NAME_LEN];
        public int dwVideoFormat;    /* 只读 视频制式 1-NTSC 2-PAL*/
        public byte byBrightness;    /*亮度,0-255*/
    ...
    public static class NET_DVR_PICCFG extends SdkStructure { //通道图象结构(SDK_V13及之前版本)
        public int dwSize;
        public byte[] sChanName = new byte[NAME_LEN];
        public int dwVideoFormat;    /* 只读 视频制式 1-NTSC 2-PAL*/
        public byte byBrightness;    /*亮度,0-255*/
    ...
    public static class NET_DVR_MULTI_STREAM_COMPRESSIONCFG_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_MULTI_STREAM_COMPRESSIONCFG extends SdkStructure {
        public int dwSize;
        public int dwStreamType;
    ...
    //码流压缩参数(子结构)(9000扩展)
    public static class NET_DVR_COMPRESSION_INFO_V30 extends SdkStructure {
    ...
    //通道压缩参数(9000扩展)
    public static class NET_DVR_COMPRESSIONCFG_V30 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_COMPRESSION_INFO extends SdkStructure {//码流压缩参数(子结构)
    ...
    public static class NET_DVR_COMPRESSIONCFG extends SdkStructure {//通道压缩参数
        public int dwSize;
    ...
    public static class NET_DVR_COMPRESSION_INFO_EX extends SdkStructure {//码流压缩参数(子结构)(扩展) 增加I帧间隔
    ...
    public static class NET_DVR_RECORDSCHED extends SdkStructure //时间段录像参数配置(子结构)
    {
    ...
    public static class NET_DVR_RECORDDAY extends SdkStructure //全天录像参数配置(子结构)
    {
    ...
    public static class NET_DVR_RECORDSCHEDWEEK extends SdkStructure {
        public NET_DVR_RECORDSCHED[] struRecordSched = new NET_DVR_RECORDSCHED[MAX_TIMESEGMENT_V30];


    }

    public static class NET_DVR_RECORD_V30 extends SdkStructure {    //通道录像参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_RECORD extends SdkStructure { //通道录像参数配置
        public int dwSize;
        public int dwRecord;  /*是否录像 0-否 1-是*/
        public NET_DVR_RECORDDAY[] struRecAllDay = new NET_DVR_RECORDDAY[MAX_DAYS];
        public NET_DVR_RECORDSCHEDWEEK[] struRecordSched = new NET_DVR_RECORDSCHEDWEEK[MAX_DAYS];
    ...
    public static class NET_DVR_STATFRAME extends SdkStructure { //单帧统计参数
    ...
    public static class NET_DVR_STATTIME extends SdkStructure { //单帧统计参数
    ...
    public static class NET_DVR_PDC_ALRAM_INFO extends SdkStructure { //通道录像参数配置
        public int dwSize;
    ...
    //云台协议表结构配置
    public static class NET_DVR_PTZ_PROTOCOL extends SdkStructure {
    ...
    public static class NET_DVR_PTZCFG extends SdkStructure {
        public int dwSize;
    ...
    /***************************云台类型(end)******************************/
    public static class NET_DVR_DECODERCFG_V30 extends SdkStructure {//通道解码器(云台)参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_DECODERCFG extends SdkStructure {//通道解码器(云台)参数配置
        public int dwSize;
        public int dwBaudRate;       //波特率(bps)，0－50，1－75，2－110，3－150，4－300，5－600，6－1200，7－2400，8－4800，9－9600，10－19200， 11－38400，12－57600，13－76800，14－115.2k;
        public byte byDataBit;         // 数据有几位 0－5位，1－6位，2－7位，3－8位;
        public byte byStopBit;         // 停止位 0－1位，1－2位;
    ...
    public static class NET_DVR_PPPCFG_V30 extends SdkStructure {//ppp参数配置(子结构)
    ...
    public static class NET_DVR_PPPCFG extends SdkStructure {//ppp参数配置(子结构)
    ...
    public static class NET_DVR_SINGLE_RS232 extends SdkStructure {//RS232串口参数配置(9000扩展)
        public int dwBaudRate;   /*波特率(bps)，0－50，1－75，2－110，3－150，4－300，5－600，6－1200，7－2400，8－4800，9－9600，10－19200， 11－38400，12－57600，13－76800，14－115.2k;*/
        public byte byDataBit;     /* 数据有几位 0－5位，1－6位，2－7位，3－8位 */
        public byte byStopBit;     /* 停止位 0－1位，1－2位 */
        public byte byParity;      /* 校验 0－无校验，1－奇校验，2－偶校验 */
    ...
    public static class NET_DVR_RS232CFG_V30 extends SdkStructure {//RS232串口参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_RS232CFG extends SdkStructure {//RS232串口参数配置
        public int dwSize;
        public int dwBaudRate;//波特率(bps)，0－50，1－75，2－110，3－150，4－300，5－600，6－1200，7－2400，8－4800，9－9600，10－19200， 11－38400，12－57600，13－76800，14－115.2k;
        public byte byDataBit;// 数据有几位 0－5位，1－6位，2－7位，3－8位;
        public byte byStopBit;// 停止位 0－1位，1－2位;
    ...
    public static class NET_DVR_ALARMINCFG_V30 extends SdkStructure {//报警输入参数配置(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_ALARMINCFG extends SdkStructure {//报警输入参数配置
        public int dwSize;
        public byte[] sAlarmInName = new byte[NAME_LEN];    /* 名称 */
        public byte byAlarmType;    //报警器类型,0：常开,1：常闭
        public byte byAlarmInHandle;    /* 是否处理 0-不处理 1-处理*/
    ...
    public static class NET_DVR_ADDIT_POSITION extends SdkStructure {//车载GPS信息结构(2007-12-27)
    ...
    public static class struRecordingHost extends SdkStructure {
    ...
    public static class struAlarmHardDisk extends SdkStructure {
        public int dwAlarmHardDiskNum;


    }

    public static class struAlarmChannel extends SdkStructure {
        public int dwAlarmChanNum;


    }

    public static class struIOAlarm extends SdkStructure {
    ...
    public static class NET_DVR_TIME_EX extends SdkStructure {
        public short wYear;
        public byte byMonth;
        public byte byDay;
        public byte byHour;
    ...
    public static class NET_DVR_ALRAM_FIXED_HEADER extends SdkStructure {
    ...
    public static class NET_DVR_ALARMINFO_V40 extends SdkStructure {
    ...
    public static class NET_DVR_ALARMINFO_V30 extends SdkStructure {//上传报警信息(9000扩展)
    ...
    public static class NET_DVR_ALARMINFO extends SdkStructure {
    ...
    public static class NET_DVR_ALARMINFO_EX extends SdkStructure {//上传报警信息(杭州竞天定制 2006-07-28)
    ...
    //////////////////////////////////////////////////////////////////////////////////////
//IPC接入参数配置
    public static class NET_DVR_IPDEVINFO extends SdkStructure {/* IP设备结构 */
    ...
    public static class NET_DVR_IPCHANINFO extends SdkStructure {/* IP通道匹配参数 */
    ...
    public static class NET_DVR_IPPARACFG extends SdkStructure {/* IP接入配置结构 */
    ...
    public class NET_DVR_IPDEVINFO_V31 extends SdkStructure {
        public byte byEnable;/* 该通道是否启用 */
    ...
    public class NET_DVR_STREAM_MODE extends SdkStructure {
    ...
    public class NET_DVR_IPSERVER_STREAM extends SdkStructure {
    ...
    public class NET_DVR_STREAM_MEDIA_SERVER_CFG extends SdkStructure {
    ...
    public class NET_DVR_DEV_CHAN_INFO extends SdkStructure {
    ...
    public class NET_DVR_PU_STREAM_CFG extends SdkStructure {
    ...
    public class NET_DVR_PU_STREAM_CFG_V41 extends SdkStructure {
        public int dwSize;
    ...
    public class NET_DVR_DDNS_STREAM_CFG extends SdkStructure {
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
    ...
    public class NET_DVR_PU_STREAM_URL extends SdkStructure {
    ...
    public class NET_DVR_HKDDNS_STREAM extends SdkStructure {
    ...
    public class NET_DVR_IPCHANINFO_V40 extends SdkStructure {
    ...
    public static class NET_DVR_IPPARACFG_V40 extends SdkStructure {/* IP接入配置结构V40 */
        public int dwSize;   /* 结构大小 */
    ...
    public static class NET_DVR_IPALARMOUTINFO extends SdkStructure {/* 报警输出参数 */
    ...
    public static class NET_DVR_IPALARMOUTCFG extends SdkStructure {/* IP报警输出配置结构 */
        public int dwSize;                                    /* 结构大小 */
    ...
    public static class NET_DVR_IPALARMININFO extends SdkStructure {/* 报警输入参数 */
        public byte byIPID;                    /* IP设备ID取值1- MAX_IP_DEVICE */
    ...
    public static class NET_DVR_IPALARMINCFG extends SdkStructure {/* IP报警输入配置结构 */
        public int dwSize;                                    /* 结构大小 */
    ...
    public static class NET_DVR_IPALARMINFO extends SdkStructure {//ipc alarm info
        public NET_DVR_IPDEVINFO[] struIPDevInfo = new NET_DVR_IPDEVINFO[MAX_IP_DEVICE];            /* IP设备 */
    ...
    public static class NET_DVR_SINGLE_HD extends SdkStructure {//本地硬盘信息配置
    ...
    public static class NET_DVR_SCALECFG extends SdkStructure {//配置缩放参数的结构
        public int dwSize;
    ...
    public static class NET_DVR_ALARMOUTCFG_V30 extends SdkStructure {//DVR报警输出(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_ALARMOUTCFG extends SdkStructure {//DVR报警输出
        public int dwSize;
        public byte[] sAlarmOutName = new byte[NAME_LEN];    /* 名称 */
        public int dwAlarmOutDelay;    /* 输出保持时间(-1为无限，手动关闭) */
        //0-5秒,1-10秒,2-30秒,3-1分钟,4-2分钟,5-5分钟,6-10分钟,7-手动
    ...
    public static class NET_DVR_PREVIEWCFG_V30 extends SdkStructure {//DVR本地预览参数(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_PREVIEWCFG extends SdkStructure {//DVR本地预览参数
        public int dwSize;
    ...
    public static class NET_DVR_VGAPARA extends SdkStructure {//DVR视频输出
     ...
     * MATRIX输出参数结构
     */
    public static class NET_DVR_MATRIXPARA_V30 extends SdkStructure {
    ...
    public static class NET_DVR_MATRIXPARA extends SdkStructure {
        public short wDisplayLogo;                        /* 显示视频通道号(保留) */
        public short wDisplayOsd;                        /* 显示时间(保留) */
    }

    public static class NET_DVR_VOOUT extends SdkStructure {
    ...
    public static class NET_DVR_VIDEOOUT_V30 extends SdkStructure {//DVR视频输出(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_VIDEOOUT extends SdkStructure {//DVR视频输出
        public int dwSize;
    ...
    public static class NET_DVR_USER_INFO_V30 extends SdkStructure {//单用户参数(子结构)(9000扩展)
        public byte[] sUserName = new byte[NAME_LEN];        /* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];        /* 密码 */
    ...
    public static class NET_DVR_USER_INFO_EX extends SdkStructure {//单用户参数(SDK_V15扩展)(子结构)
        public byte[] sUserName = new byte[NAME_LEN];        /* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];        /* 密码 */
    ...
    public static class NET_DVR_USER_INFO extends SdkStructure {//单用户参数(子结构)
        public byte[] sUserName = new byte[NAME_LEN];        /* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];        /* 密码 */
        public int[] dwLocalRight = new int[MAX_RIGHT];    /* 权限 */
        /*数组0: 本地控制云台*/
    ...
    public static class NET_DVR_USER_V30 extends SdkStructure {//DVR用户参数(9000扩展)
        public int dwSize;
        public NET_DVR_USER_INFO_V30[] struUser = new NET_DVR_USER_INFO_V30[MAX_USERNUM_V30];
    }

    public static class NET_DVR_USER_EX extends SdkStructure {//DVR用户参数(SDK_V15扩展)
        public int dwSize;
        public NET_DVR_USER_INFO_EX[] struUser = new NET_DVR_USER_INFO_EX[MAX_USERNUM];
    }

    public static class NET_DVR_USER extends SdkStructure {//DVR用户参数
        public int dwSize;
        public NET_DVR_USER_INFO[] struUser = new NET_DVR_USER_INFO[MAX_USERNUM];
    }

    public static class NET_DVR_EXCEPTION_V30 extends SdkStructure {//DVR异常参数(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_EXCEPTION extends SdkStructure {//DVR异常参数
        public int dwSize;
    ...
    public static class NET_DVR_CHANNELSTATE_V30 extends SdkStructure {//通道状态(9000扩展)
    ...
    public static class NET_DVR_CHANNELSTATE extends SdkStructure {//通道状态
        public byte byRecordStatic; //通道是否在录像,0-不录像,1-录像
        public byte bySignalStatic; //连接的信号状态,0-正常,1-信号丢失
        public byte byHardwareStatic;//通道硬件状态,0-正常,1-异常,例如DSP死掉
    ...
    public static class NET_DVR_DISKSTATE extends SdkStructure {//硬盘状态
        public int dwVolume;//硬盘的容量
        public int dwFreeSpace;//硬盘的剩余空间
        public int dwHardDiskStatic; //硬盘的状态,按位:1-休眠,2-不正常,3-休眠硬盘出错
    }

    public static class NET_DVR_WORKSTATE_V30 extends SdkStructure {//DVR工作状态(9000扩展)
    ...
    public static class NET_DVR_WORKSTATE extends SdkStructure {//DVR工作状态
        public int dwDeviceStatic;    //设备的状态,0-正常,1-CPU占用率太高,超过85%,2-硬件错误,例如串口死掉
    ...
    public static class NET_DVR_LOG_V30 extends SdkStructure {//日志信息(9000扩展)
    ...
    //日志信息
    public static class NET_DVR_LOG extends SdkStructure {
        public NET_DVR_TIME strLogTime;
        public int dwMajorType;    //主类型 1-报警; 2-异常; 3-操作; 0xff-全部
        public int dwMinorType;//次类型 0-全部;
        public byte[] sPanelUser = new byte[MAX_NAMELEN]; //操作面板的用户名
    ...
    /************************DVR日志 end***************************/
    public static class NET_DVR_ALARMOUTSTATUS_V30 extends SdkStructure {//报警输出状态(9000扩展)
        public byte[] Output = new byte[MAX_ALARMOUT_V30];
    }

    public static class NET_DVR_ALARMOUTSTATUS extends SdkStructure {//报警输出状态
        public byte[] Output = new byte[MAX_ALARMOUT];
    }

    public static class NET_DVR_TRADEINFO extends SdkStructure {//交易信息
        public short m_Year;
    ...
    public static class NET_DVR_FRAMETYPECODE extends SdkStructure {/*帧格式*/
        public byte[] code = new byte[12];        /* 代码 */
    }

    public static class NET_DVR_FRAMEFORMAT_V30 extends SdkStructure {//ATM参数(9000扩展)
        public int dwSize;
    ...
    public static class NET_DVR_FRAMEFORMAT extends SdkStructure {//ATM参数
        public int dwSize;
    ...
    public static class NET_DVR_FTPTYPECODE extends SdkStructure {
        public byte[] sFtpType = new byte[32];     /*客户定义的操作类型*/
        public byte[] sFtpCode = new byte[8];      /*客户定义的操作类型的对应的码*/
    }

    public static class NET_DVR_FRAMEFORMAT_EX extends SdkStructure {//ATM参数添加FTP上传参数, 俄罗斯银行定制, 2006-11-17
        public int dwSize;
        public byte[] sATMIP = new byte[16];                        /* ATM IP地址 */
        public int dwATMType;                        /* ATM类型 */
        public int dwInputMode;                        /* 输入方式	0-网络侦听 1-网络接收 2-串口直接输入 3-串口ATM命令输入*/
...
/****************************ATM(end)***************************/
    ...
    /*****************************DS-6001D/F(begin)***************************/
//DS-6001D Decoder
    public static class NET_DVR_DECODERINFO extends SdkStructure {
    ...
    public static class NET_DVR_DECODERSTATE extends SdkStructure {
        public byte[] byEncoderIP = new byte[16];        //解码设备连接的服务器IP
        public byte[] byEncoderUser = new byte[16];        //解码设备连接的服务器的用户名
        public byte[] byEncoderPasswd = new byte[16];    //解码设备连接的服务器的密码
        public byte byEncoderChannel;        //解码设备连接的服务器的通道号
    ...
    public static class NET_DVR_DECCHANINFO extends SdkStructure {
        public byte[] sDVRIP = new byte[16];                /* DVR IP地址 */
        public short wDVRPort;                    /* 端口号 */
        public byte[] sUserName = new byte[NAME_LEN];        /* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];        /* 密码 */
    ...
    public static class NET_DVR_DECINFO extends SdkStructure {/*每个解码通道的配置*/
    ...
    public static class NET_DVR_DECCFG extends SdkStructure {/*整个设备解码配置*/
        public int dwSize;
    ...
    //2005-08-01
    public static class NET_DVR_PORTINFO extends SdkStructure {/* 解码设备透明通道设置 */
    ...
    public static class NET_DVR_PORTCFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_PLAYREMOTEFILE extends SdkStructure {/* 控制网络文件回放 */
        public int dwSize;
        public byte[] sDecoderIP = new byte[16];        /* DVR IP地址 */
        public short wDecoderPort;            /* 端口号 */
    ...
    public static class NET_DVR_DECCHANSTATUS extends SdkStructure {/*当前设备解码连接状态*/
    ...
    public static class NET_DVR_DECSTATUS extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_SHOWSTRINGINFO extends SdkStructure {//单字符参数(子结构)
...
DVR实现巡航数据结构
*/
    public static class NET_DVR_CRUISE_PARA extends SdkStructure {
        public int dwSize;
...
//时间点
    public static class NET_DVR_TIMEPOINT extends SdkStructure {
    ...
    //夏令时参数
    public static class NET_DVR_ZONEANDDST extends SdkStructure {
        public int dwSize;
    ...
    //图片质量
    public static class NET_DVR_JPEGPARA extends SdkStructure {
...
//辅助输出参数配置
    public static class NET_DVR_AUXOUTCFG extends SdkStructure {
        public int dwSize;
    ...
    //ntp
    public static class NET_DVR_NTPPARA extends SdkStructure {
    ...
    //ddns
    public static class NET_DVR_DDNSPARA extends SdkStructure {
    ...
    public static class NET_DVR_DDNSPARA_EX extends SdkStructure {
    ...
    public static class NET_DVR_DDNS extends SdkStructure {
    ...
    //9000扩展
    public static class NET_DVR_DDNSPARA_V30 extends SdkStructure {
    ...
    //email
    public static class NET_DVR_EMAILPARA extends SdkStructure {
    ...
    public static class NET_DVR_NETAPPCFG extends SdkStructure {//网络参数配置
        public int dwSize;
    ...
    public static class NET_DVR_SINGLE_NFS extends SdkStructure {//nfs结构配置
        public byte[] sNfsHostIPAddr = new byte[16];
        public byte[] sNfsDirectory = new byte[PATHNAME_LEN];        // PATHNAME_LEN = 128
    }

    public static class NET_DVR_NFSCFG extends SdkStructure {
        public int dwSize;
        public NET_DVR_SINGLE_NFS[] struNfsDiskParam = new NET_DVR_SINGLE_NFS[MAX_NFS_DISK];
    }

    //巡航点配置(HIK IP快球专用)
    public static class NET_DVR_CRUISE_POINT extends SdkStructure {
    ...
    public static class NET_DVR_CRUISE_RET extends SdkStructure {
        public NET_DVR_CRUISE_POINT[] struCruisePoint = new NET_DVR_CRUISE_POINT[32];            //最大支持32个巡航点
    }

    /************************************多路解码器(begin)***************************************/
//多路解码器扩展 added by zxy 2007-05-23
    public static class NET_DVR_NETCFG_OTHER extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_DECINFO extends SdkStructure {
        public byte[] sDVRIP = new byte[16];                /* DVR IP地址 */
        public short wDVRPort;                /* 端口号 */
        public byte byChannel;                /* 通道号 */
    ...
    public static class NET_DVR_MATRIX_DYNAMIC_DEC extends SdkStructure {//启动/停止动态解码
        public int dwSize;
        public NET_DVR_MATRIX_DECINFO struDecChanInfo;        /* 动态解码通道信息 */
    }

    public static class NET_DVR_MATRIX_DEC_CHAN_STATUS extends SdkStructure {//2007-12-13 modified by zxy 修改多路解码器的NET_DVR_MATRIX_DEC_CHAN_STATUS结构
...
//end 2007-12-13 modified by zxy
    ...
    public static class NET_DVR_MATRIX_DEC_CHAN_INFO extends SdkStructure {
        public int dwSize;
    ...
    //连接的通道配置 2007-11-05
    public static class NET_DVR_MATRIX_DECCHANINFO extends SdkStructure {
        public int dwEnable;                    /* 是否启用 0－否 1－启用*/
        public NET_DVR_MATRIX_DECINFO struDecChanInfo;        /* 轮循解码通道信息 */
    }

    //2007-11-05 新增每个解码通道的配置
    public static class NET_DVR_MATRIX_LOOP_DECINFO extends SdkStructure {
        public int dwSize;
...
//矩阵行信息 2007-12-28
    public static class NET_DVR_MATRIX_ROW_ELEMENT extends SdkStructure {
    ...
    public static class NET_DVR_MATRIX_ROW_INDEX extends SdkStructure {
        public byte[] sSurvChanName = new byte[128];            /* 监控通道名称，支持中文 */
        public int dwRowNum;                /* 行号 */
    }

    //矩阵列信息 2007-12-28
    public static class NET_DVR_MATRIX_COLUMN_ELEMENT extends SdkStructure {
        public int dwLocalDispChanNum;    /* 本地显示通道号 */
        public int dwGlobalDispChanNum;    /* 全局显示通道号 */
        public int dwRes;            /* 保留 */
    }

    public static class NET_DVR_MATRIX_GLOBAL_COLUMN_ELEMENT extends SdkStructure {
    ...
    //手动查看 2007-12-28
    public static class NET_DVR_MATRIX_ROW_COLUMN_LINK extends SdkStructure {
        public int dwSize;
        /*
    ...
    public static class NET_DVR_MATRIX_PREVIEW_DISP_CHAN extends SdkStructure {
        public int dwSize;
        public int dwGlobalDispChanNum;        /* 电视墙上的电视机编号 */
        public int dwLocalDispChanNum;        /* 解码通道 */
    }

    public static class NET_DVR_MATRIX_LOOP_PLAY_SET extends SdkStructure {//轮循功能 2007-12-28
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_LOCAL_HOST_INFO extends SdkStructure {//矩阵中心配置 2007-12-28
        public int dwSize;
    ...
    //2007-12-22
    public static class TTY_CONFIG extends SdkStructure {
    ...
    public static class NET_DVR_MATRIX_TRAN_CHAN_INFO extends SdkStructure {
    ...
    public static class NET_DVR_MATRIX_TRAN_CHAN_CONFIG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_DEC_REMOTE_PLAY extends SdkStructure {
        public int dwSize;
        public byte[] sDVRIP = new byte[16];        /* DVR IP地址 */
        public short wDVRPort;            /* 端口号 */
        public byte byChannel;            /* 通道号 */
    ...
    public static class NET_DVR_MATRIX_DEC_REMOTE_PLAY_CONTROL extends SdkStructure {
        public int dwSize;
        public int dwPlayCmd;        /* 播放命令 见文件播放命令*/
        public int dwCmdParam;        /* 播放命令参数 */
    }

    public static class NET_DVR_MATRIX_DEC_REMOTE_PLAY_STATUS extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_MATRIX_PASSIVEMODE extends SdkStructure {
...
/************************************多路解码器(end)***************************************/
    ...
    public static class NET_DVR_VIDEO_WALL_INFO extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_SCENE_CONTROL_INFO extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_BUF_INFO extends SdkStructure {
        public Pointer pBuf;
        public int nLen;
    }

    public static class NET_DVR_IN_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_OUT_PARAM extends SdkStructure {
        public NET_DVR_BUF_INFO struOutBuf;
        public Pointer lpStatusList;
        public byte[] byRes = new byte[32];
    }

    public static class NET_DVR_RECTCFG_EX extends SdkStructure {
    ...
    public static class NET_DVR_VIDEOWALLWINDOWPOSITION extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_WALLWINPARAM extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_PLAN_LIST extends SdkStructure {
        public int dwSize;
    ...
    /*预案项信息*/
    public static class NET_DVR_PLAN_INFO extends SdkStructure {
    ...
    public static class NET_DVR_CYCLE_TIME extends SdkStructure {
        public byte byValid;
        public byte[] byRes = new byte[3];
    ...
    /*预案管理*/
    public static class NET_DVR_PLAN_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_WALLSCENECFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_SUBWND_DECODE_OSD extends SdkStructure {
        public int dwSize = 0;
    ...
    public static class NET_DVR_OSD_INFO extends SdkStructure {
    ...
    public static class NET_DVR_DEV_CHAN_INFO_EX extends SdkStructure {
    ...
    public static class NET_DVR_STREAM_MEDIA_SERVER extends SdkStructure {
    ...
    public static class NET_DVR_DEV_DDNS_INFO extends SdkStructure {
    ...
    public static class NET_DVR_DEC_STREAM_DEV_EX extends SdkStructure {
    ...
    //DDNS方式取流
    public static class NET_DVR_DEC_DDNS_DEV extends SdkStructure {
    ...
    public static class NET_DVR_MATRIX_CHAN_INFO_V41 extends SdkStructure {
    ...
    public static class NET_DVR_MATRIX_LOOP_DECINFO_V41 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_EMAILCFG extends SdkStructure {    /* 12 bytes */
        public int dwSize;
    ...
    public static class NET_DVR_COMPRESSIONCFG_NEW extends SdkStructure {
        public int dwSize;
    ...
    //球机位置信息
    public static class NET_DVR_PTZPOS extends SdkStructure {
    ...
    //球机范围信息
    public static class NET_DVR_PTZSCOPE extends SdkStructure {
    ...
    public static class NET_DVR_PTZABSOLUTEEX_CFG extends SdkStructure {
        public int dwSize;//结构体大小
    ...
    //rtsp配置 ipcamera专用
    public static class NET_DVR_RTSPCFG extends SdkStructure {
...
//NET_DVR_Login()参数结构
    public static class NET_DVR_DEVICEINFO extends SdkStructure {
        public byte[] sSerialNumber = new byte[SERIALNO_LEN];   //序列号
        public byte byAlarmInPortNum;                //DVR报警输入个数
        public byte byAlarmOutPortNum;                //DVR报警输出个数
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends SdkStructure {
        public byte[] sSerialNumber = new byte[SERIALNO_LEN];  //序列号
    ...
    public static class NET_DVR_USER_LOGIN_INFO extends SdkStructure {
    ...
    //NET_DVR_Login_V40()参数
// public static class NET_DVR_DEVICEINFO_V40 extends SdkStructure
    public static class NET_DVR_DEVICEINFO_V40 extends SdkStructure {
    ...
    // //软解码预览参数
// public static class NET_DVR_CLIENTINFO extends SdkStructure {
//         public int lChannel;
...
//
    //预览V40接口
    public static class NET_DVR_PREVIEWINFO extends SdkStructure {
    ...
    public static class NET_DVR_STREAM_INFO extends SdkStructure {
        public int dwSize;
    ...
    //配置条件
    public static class NET_DVR_CLOUDSTORAGE_COND extends SdkStructure {
        public int dwSize;
        public int dwChannel;
        public byte[] byRes1 = new byte[64];
    }

    public static class NET_DVR_STREAM_RECORD_STATUS extends SdkStructure {
        public int dwSize;
    ...
    //SDK状态信息(9000新增)
    public static class NET_DVR_SDKSTATE extends SdkStructure {
    ...
    //SDK功能支持信息(9000新增)
    public static class NET_DVR_SDKABL extends SdkStructure {
    ...
    //报警设备信息
    public static class NET_DVR_ALARMER extends SdkStructure {
    ...
    //硬解码显示区域参数(子结构)
    public static class NET_DVR_DISPLAY_PARA extends SdkStructure {
    ...
    //硬解码预览参数
    public static class NET_DVR_CARDINFO extends SdkStructure {
        public int lChannel;//通道号
    ...
    //录象文件参数
    public static class NET_DVR_FIND_DATA extends SdkStructure {
    ...
    //录象文件参数(9000)
    public static class NET_DVR_FINDDATA_V30 extends SdkStructure {
        public byte[] sFileName = new byte[100];//文件名
        public NET_DVR_TIME struStartTime;//文件的开始时间
        public NET_DVR_TIME struStopTime;//文件的结束时间
        public int dwFileSize;//文件的大小
    ...
    //录象文件参数(带卡号)
    public static class NET_DVR_FINDDATA_CARD extends SdkStructure {
        public byte[] sFileName = new byte[100];//文件名
        public NET_DVR_TIME struStartTime;//文件的开始时间
        public NET_DVR_TIME struStopTime;//文件的结束时间
        public int dwFileSize;//文件的大小
    ...
    public static class NET_DVR_FILECOND_V40 extends SdkStructure {
        public int lChannel;
    ...
    public static class NET_DVR_ATMFINDINFO extends SdkStructure {
    ...
    //录像文件查找条件结构V50
    public static class NET_DVR_FILECOND_V50 extends SdkStructure {
    ...
    public static class NET_DVR_FINDDATA_V40 extends SdkStructure {
        public byte[] sFileName = new byte[100];//文件名
    ...
    public static class NET_DVR_TIME_SEARCH extends SdkStructure {
    ...
    public static class NET_DVR_ADDRESS extends SdkStructure {
        public NET_DVR_IPADDR struIP = new NET_DVR_IPADDR(); //IP地址
        public short wPort;    //端口号
        public byte[] byRes = new byte[2];
    }

    public static class NET_DVR_FINDDATA_V50 extends SdkStructure {
    ...
    public static class NET_DVR_FILECOND extends SdkStructure //录象文件查找条件结构
    {
        public int lChannel;//通道号
    ...
    public static class NET_DVR_PLAYCOND extends SdkStructure //回放或者下载信息结构体
    {
        public int dwChannel;//通道号
...
//  public static class NET_DVR_VOD_PARA extends SdkStructure //回放或者下载信息结构体
//     {
//         public int dwSize;
...
// }
    ...
    //图片查找条件
    public static class NET_DVR_FIND_PICTURE_PARAM extends SdkStructure {
        public int dwSize;         // 结构体大小
        public int lChannel;       // 通道号
    ...
    public class NET_DVR_FIND_PICTURE_V50 extends SdkStructure {
    ...
    public class NET_DVR_PIC_PARAM extends SdkStructure {
    ...
    //查找结果结构体
    public static class NET_DVR_FIND_PICTURE_V40 extends SdkStructure {
        public byte[] sFileName = new byte[PICTURE_NAME_LEN];//图片名
        public NET_DVR_TIME struTime = new NET_DVR_TIME();//图片的时间
        public int dwFileSize;//图片的大小
        public byte[] sCardNum = new byte[CARDNUM_LEN_V30];    //卡号
    ...
    //云台区域选择放大缩小(HIK 快球专用)
    public static class NET_DVR_POINT_FRAME extends SdkStructure {
    ...
    //语音对讲参数
    public static class NET_DVR_COMPRESSION_AUDIO extends SdkStructure {
        public byte byAudioEncType;   //音频编码类型 0-G722; 1-G711
        public byte[] byres = new byte[7];//这里保留音频的压缩参数
    }

    public static class NET_DVR_AUDIODEC_INFO extends SdkStructure {
    ...
    //音频解码
    public static class NET_DVR_AUDIODEC_PROCESS_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_AUDIOENC_INFO extends SdkStructure {
        public int in_frame_size;                /* 输入一帧数据大小(BYTES)，由GetInfoParam函数返回         */
        public int[] reserved = new int[16];                 /* 保留 */
    }

    //音频编码
    public static class NET_DVR_AUDIOENC_PROCESS_PARAM extends SdkStructure {
    ...
    //用于接收报警信息的缓存区
    public static class RECV_ALARM extends SdkStructure {
        public byte[] RecvBuffer = new byte[4000];//此处的400应不小于最大报警报文长度
    }

    //布防参数
    public static class NET_DVR_SETUPALARM_PARAM extends SdkStructure {
        public int dwSize;
    ...
    //区域框参数
    public static class NET_VCA_RECT extends SdkStructure {
        public float fX;
        public float fY;
        public float fWidth;
    ...
    //报警目标信息
    public static class NET_VCA_TARGET_INFO extends SdkStructure {
        public int dwID;
    ...
    //前端设备信息
    public static class NET_VCA_DEV_INFO extends SdkStructure {
    ...
    //事件规则信息
    public static class NET_VCA_RULE_INFO extends SdkStructure {
    ...
    //穿越警戒面参数
    public static class NET_VCA_TRAVERSE_PLANE extends SdkStructure {
    ...
    public static class NET_DVR_HANDLEEXCEPTION_V40 extends SdkStructure {
    ...
    public static class NET_VCA_TRAVERSE_PLANE_DETECTION extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_VCA_INTRUSION extends SdkStructure {
    ...
    */
    ...
    public static class NET_VCA_FIELDDETECION extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CHANNEL_GROUP extends SdkStructure {
        public int dwSize;
        public int dwChannel;
        public int dwGroup;
        public byte byID;
    ...
    //线结构参数
    public static class NET_VCA_LINE extends SdkStructure {
        public NET_VCA_POINT struStart;
        public NET_VCA_POINT struEnd;
    }

    //点坐标参数
    public static class NET_VCA_POINT extends SdkStructure {
        public float fX;
        public float fY;
    ...
    //进入/离开区域参数
    public static class NET_VCA_AREA extends SdkStructure {
        public NET_VCA_POLYGON struRegion;
        public byte[] byRes = new byte[8];
    }

    //多边形结构体
    public static class NET_VCA_POLYGON extends SdkStructure {
        public int dwPointNum;
        public NET_VCA_POINT[] struPos = new NET_VCA_POINT[VCA_MAX_POLYGON_POINT_NUM];
    }

    public static class NET_VCA_SIZE_FILTER extends SdkStructure {
    ...
    //尺寸过滤策略
    public static class NET_VCA_FILTER_STRATEGY extends SdkStructure {
        public byte byStrategy;      //尺寸过滤策略 0 - 不启用 1-高度和宽度过滤,2-面积过滤
        public byte[] byRes = new byte[11];       //保留
    }

    //行为分析报警
    public static class NET_VCA_RULE_ALARM extends SdkStructure {
        public int dwSize;
        public int dwRelativeTime;
    ...
    public static class NET_DVR_SYSTEM_TIME extends SdkStructure {
    ...
    public static class NET_AIOP_VIDEO_HEAD extends SdkStructure {
    ...
    public static class NET_AIOP_PICTURE_HEAD extends SdkStructure {
    ...
    public static class NET_DVR_AI_PICTUR_UPLOAD extends SdkStructure {
        public int dwSize;
    ...
    //规则触发参数
    public static class NET_VCA_RULE_TRIGGER_PARAM extends SdkStructure {
    ...
    public static class NET_VCA_ONE_RULE_V42 extends SdkStructure {
    ...
    public static class NET_DVR_PTZ_POSITION extends SdkStructure {
    ...
    //行为分析配置结构体
    public static class NET_VCA_RULECFG_V42 extends SdkStructure {
    ...
    public static class NET_DVR_CID_ALARM extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_SENSOR_ALARM extends SdkStructure {
        public int dwSize;                // 结构体大小
    ...
    //开关量报警上传
    public static class NET_DVR_SWITCH_ALARM extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_ALARMHOST_EXCEPTION_ALARM extends SdkStructure {
        public int dwSize;             // 结构体大小
    ...
    public static class NET_DVR_ALARMHOST_POINT_VALUE extends SdkStructure {
    ...
    public static class NET_DVR_ALARMHOST_DATA_UNION extends SdkStructure {
        public byte[] byLength = new byte[40];
        public NET_DVR_ALARMHOST_POINT_VALUE struPointValue;    //监测点实时数据
    }

    public static class NET_DVR_ALARMHOST_DATA_UPLOAD extends SdkStructure {
        public int dwSize;
    ...
    //车牌识别结果子结构
    public static class NET_DVR_PLATE_INFO extends SdkStructure {
    ...
    public static class NET_DVR_VEHICLE_INFO extends SdkStructure {
    ...
    */
    ...
    //手动抓拍
    public static class NET_DVR_MANUALSNAP extends SdkStructure {
    ...
    //交通抓拍结果信息
    public static class NET_DVR_PLATE_RESULT extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_TIME_V30 extends SdkStructure {
        public short wYear;
        public byte byMonth;
        public byte byDay;
        public byte byHour;
    ...
    public static class NET_ITS_PICTURE_INFO extends SdkStructure {
    ...
    public static class NET_ITS_PLATE_RESULT extends SdkStructure {
        public int dwSize;
    ...
    //停车场数据上传
    public static class NET_ITS_PARK_VEHICLE extends SdkStructure {
    ...
    public static class NET_DVR_SNAPCFG extends SdkStructure {
    ...
    // 道闸控制
    public static class NET_DVR_BARRIERGATE_CFG extends SdkStructure {
        public int dwSize;
        public int dwChannel; //通道号
    ...
    */
    ...
    public static class NET_DVR_AGEGROUP_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_SEXGROUP_PARAM extends SdkStructure {
        public int dwMale;//男（人数）
        public int dwFemale;//女（人数）
        public byte[] byRes = new byte[64];
    }

    public static class NET_DVR_PROGRAM_INFO extends SdkStructure {
        public int dwProgramNo; //节目编号
        public byte[] sProgramName = new byte[NAME_LEN]; //节目名称
        public byte[] byRes = new byte[16];
    }

    public static class NET_DVR_FACECAPTURE_STATISTICS_RESULT extends SdkStructure {
        public int dwSize;
    ...
    //获取交通数据条件结构
    public static class NET_DVR_TRAFFIC_DATA_QUERY_COND extends SdkStructure {
        public int dwSize;
        /*
       Bit0-通道有效
       Bit1-时间有效
    ...
    //交通数据结构体
    public static class NET_DVR_TRAFFIC_DATA_QUERY_RESULT extends SdkStructure {
        public int dwSize;
    ...
    */
    ...
    public static class NET_DVR_TRAFFIC_PICTURE_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_VEHICLE_CONTROL_COND extends SdkStructure {
        public int dwChannel;
    ...
    public static class NET_DVR_VEHICLE_CONTROL_LIST_INFO extends SdkStructure {
        public int dwSize;
        public int dwChannel;
        public int dwDataIndex;
    ...
    //车辆报警
    public static class NET_DVR_VEHICLE_CONTROL_ALARM extends SdkStructure {
        public int dwSize;
    ...
    //LED屏幕显示参数
    public static class NET_DVR_LEDDISPLAY_CFG extends SdkStructure {
        public int dwSize;//结构体大小
    ...
    //语音播报控制参数
    public static class NET_DVR_VOICEBROADCAST_CFG extends SdkStructure {
        public int dwSize;//结构体大小
    ...
    //缴费金额信息
    public static class NET_DVR_CHARGEACCOUNT_CFG extends SdkStructure {
        public int dwSize;//结构体大小
    ...
    public static class NET_DVR_DOOR_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_DOOR_STATUS_PLAN extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_EVENT_CARD_LINKAGE_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_EVENT_CARD_LINKAGE_CFG_V50 extends SdkStructure {
        public int dwSize;    //结构体大小
    ...
    public static class NET_DVR_EVENT_LINKAGE_INFO extends SdkStructure {
    ...
    //卡参数配置条件
    public static class NET_DVR_CARD_CFG_COND extends SdkStructure {
        public int dwSize;
    ...
    //获取卡参数的发送数据
    public static class NET_DVR_CARD_CFG_SEND_DATA extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[32];
        public byte[] byRes = new byte[16];
    }

    public static class CARDRIGHTPLAN extends SdkStructure {
        public byte[] byRightPlan = new byte[4];
    }

    //卡参数
    public static class NET_DVR_CARD_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class CARDRIGHTPLAN_WORD extends SdkStructure {
        public short[] wRightPlan = new short[MAX_CARD_RIGHT_PLAN_NUM];
    }

    public static class NET_DVR_CARD_CFG_V50 extends SdkStructure {
        public int dwSize;
    ...
    //有效期参数结构体
    public static class NET_DVR_VALID_PERIOD_CFG extends SdkStructure {
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
    ...
    //扩展结构体信息
    public static class NET_DVR_ID_CARD_INFO_EXTEND extends SdkStructure {
    ...
    //身份证信息报警
    public static class NET_DVR_ID_CARD_INFO_ALARM extends SdkStructure {
        public int dwSize;        //结构长度
    ...
    public static class NET_DVR_CARD_READER_CFG_V50 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CARD_COND extends SdkStructure {
        public int dwSize;
        public int dwCardNum; //设置或获取卡数量，获取时置为0xffffffff表示获取所有卡信息
        public byte[] byRes = new byte[64];
    }

    public static class NET_DVR_CARD_SEND_DATA extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //卡号
        public byte[] byRes = new byte[16];
    }

    public static class NET_DVR_CARD_RECORD extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CARD_STATUS extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FACE_COND extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FACE_RECORD extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
    ...
    public static class NET_DVR_FACE_STATUS extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];
...
//开锁记录
    public static class NET_DVR_UNLOCK_RECORD_INFO extends SdkStructure {
    ...
    //公告信息阅读回执
    public static class NET_DVR_NOTICEDATA_RECEIPT_INFO extends SdkStructure {
        public byte[] byNoticeNumber = new byte[MAX_NOTICE_NUMBER_LEN]; //公告编号
        public byte[] byRes = new byte[224];  //保留
    }

    //认证记录（设备未实现）
    public static class NET_DVR_AUTH_INFO extends SdkStructure {
    ...
    //车牌信息上传
    public static class NET_DVR_UPLOAD_PLATE_INFO extends SdkStructure {
        public byte[] sLicense = new byte[MAX_LICENSE_LEN];        //车牌号码
        public byte byColor;                      //车牌颜色，参考结构VCA_PLATE_COLOR
        public byte[] byRes = new byte[239];  //保留
    }

    public static class NET_DVR_SEND_CARD_INFO extends SdkStructure {
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN/*32*/]; //卡号
        public byte[] byRes = new byte[224];  //保留
    }
    ...
    //可视对讲事件记录
    public static class NET_DVR_VIDEO_INTERCOM_EVENT extends SdkStructure {
        public int dwSize; //结构体大小
    ...
    public static class NET_DVR_CONTROL_GATEWAY extends SdkStructure {
        public int dwSize; //结构体大小
    ...
    //公告图片信息结构体
    public static class NET_DVR_NOTICE_PIC extends SdkStructure {
    ...
    //公告数据
    public static class NET_DVR_NOTICE_DATA extends SdkStructure {
        public int dwSize; //结构体大小
    ...
    public static class NET_DVR_DATE extends SdkStructure {
        public short wYear;        //年
    ...
    //身份证信息
    public static class NET_DVR_ID_CARD_INFO extends SdkStructure {
        public int dwSize;        //结构长度
    ...
    public static class NET_DVR_ACS_EVENT_INFO_EXTEND_V20 extends SdkStructure {
        public byte byRemoteCheck; //是否需要远程核验（0-无效，1-不需要（默认），2-需要）
        public byte byThermometryUnit; //测温单位（0-摄氏度（默认），1-华氏度，2-开尔文）
        public byte byIsAbnomalTemperature; //人脸抓拍测温是否温度异常：1-是，0-否
        public byte byRes2;
    ...
    //门禁主机报警信息结构体
    public static class NET_DVR_ACS_ALARM_INFO extends SdkStructure {
        public int dwSize;
        public int dwMajor; //报警主类型，参考宏定义
        public int dwMinor; //报警次类型，参考宏定义
    ...
    //门禁主机事件信息
    public static class NET_DVR_ACS_EVENT_INFO extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[32];
        public byte byCardType;
    ...
    public static class NET_DVR_ACS_EVENT_INFO_EXTEND extends SdkStructure {
    ...
    public static class NET_DVR_ACS_EVENT_DETAIL extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_ACS_EVENT_CFG extends SdkStructure {
        public int dwSize;
        public int dwMajor; //报警主类型，参考宏定义
        public int dwMinor; //报警次类型，参考宏定义
        public NET_DVR_TIME struTime = new NET_DVR_TIME(); //时间
    ...
    public static class NET_DVR_ACS_EVENT_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_ACS_WORK_STATUS_V50 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_FACE_PARAM_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_FACE_PARAM_CFG extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN];    //人脸关联的卡号
    ...
    public static class NET_DVR_FACE_PARAM_STATUS extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //人脸关联的卡号
    ...
    public static class NET_DVR_FACE_PARAM_BYCARD extends SdkStructure {
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //人脸关联的卡号
    ...
    public static class NET_DVR_FACE_PARAM_BYREADER extends SdkStructure {
    ...
    public static class NET_DVR_FACE_PARAM_CTRL extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CHECK_FACE_PICTURE_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CHECK_FACE_PICTURE_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CHECK_FACE_PICTURE_STATUS extends SdkStructure {
        public int dwSize;
        public int dwPictureNo; //图片编号
    ...
    public static class NET_DVR_FINGER_PRINT_CFG_V50 extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_FINGER_PRINT_STATUS_V50 extends SdkStructure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; //指纹关联的卡号
    ...
    public static class NET_DVR_FINGER_PRINT_INFO_COND_V50 extends SdkStructure {
        public int dwSize;
    ...
    //自定义结构体，用于二维数组转换
    public static class NET_DVR_SINGLE_PLAN_SEGMENT_WEEK extends SdkStructure {
        public NET_DVR_SINGLE_PLAN_SEGMENT[] struPlanCfgDay = new NET_DVR_SINGLE_PLAN_SEGMENT[MAX_TIMESEGMENT_V30]; //一天的计划参数
    }

    public static class NET_DVR_WEEK_PLAN_CFG extends SdkStructure {
        public int dwSize;
        public byte byEnable;  //是否使能，1-使能，0-不使能
        public byte[] byRes1 = new byte[3];
    ...
    public static class NET_DVR_SINGLE_PLAN_SEGMENT extends SdkStructure {
        public byte byEnable; //是否使能，1-使能，0-不使能
    ...
    public static class NET_DVR_TIME_SEGMENT extends SdkStructure {
        public NET_DVR_SIMPLE_DAYTIME struBeginTime; //开始时间点
        public NET_DVR_SIMPLE_DAYTIME struEndTime;   //结束时间点
    }

    public static class NET_DVR_SIMPLE_DAYTIME extends SdkStructure {
    ...
    public static class NET_DVR_WEEK_PLAN_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_PLAN_TEMPLATE extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_PLAN_TEMPLATE_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CAPTURE_FACE_COND extends SdkStructure {
        public int dwSize;
        public byte[] byRes = new byte[128];
    }

    public static class NET_DVR_FACE_FEATURE extends SdkStructure {
    ...
    public static class NET_DVR_CAPTURE_FACE_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_XML_CONFIG_INPUT extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_STRING_POINTER extends SdkStructure {
        public byte[] byString = new byte[2 * 1024];
    }

    public static class NET_DVR_XML_CONFIG_OUTPUT extends SdkStructure {
        public int dwSize;
    ...
    //报警场景信息
    public static class NET_DVR_SCENE_INFO extends SdkStructure {
    ...
    //交通取证报警
    public static class NET_DVR_TFS_ALARM extends SdkStructure {
        public int dwSize;                //结构体大小
    ...
    public static class NET_ITS_OVERLAPCFG_COND extends SdkStructure {
        public int dwSize;
        public int dwChannel;
    ...
    //字符叠加每一条信息结构体
    public static class NET_ITS_OVERLAP_SINGLE_ITEM_PARAM_V50 extends SdkStructure {
        public byte[] byRes1 = new byte[2];                   // 保留
    ...
    public static class NET_ITS_OVERLAP_ITEM_PARAM_V50 extends SdkStructure {
    ...
    //叠加项具体信息
    public static class NET_ITS_OVERLAP_INFO_PARAM extends SdkStructure {
    ...
    public static class NET_ITS_OVERLAP_CFG_V50 extends SdkStructure {
        public int dwSize;
    ...
    //人体特征识别结果结构体
    public static class NET_VCA_HUMAN_FEATURE extends SdkStructure {
    ...
    //人脸抓拍附加信息结构体
    public static class NET_VCA_FACESNAP_ADDINFO extends SdkStructure {
    ...
    //人脸抓拍结果
    public static class NET_VCA_FACESNAP_RESULT extends SdkStructure {
        public int dwSize;             // 结构大小
        public int dwRelativeTime;     // 相对时标
        public int dwAbsTime;            // 绝对时标
    ...
    //人脸抓拍信息
    public static class NET_VCA_FACESNAP_INFO_ALARM extends SdkStructure {
        public int dwRelativeTime;     // 相对时标
        public int dwAbsTime;            // 绝对时标
    ...
    //籍贯参数
    public static class NET_DVR_AREAINFOCFG extends SdkStructure {
    ...
    public static class NET_VCA_HUMAN_ATTRIBUTE extends SdkStructure {
    ...
    //禁止名单信息
    public static class NET_VCA_BLOCKLIST_INFO extends SdkStructure {
        public int dwSize;   //结构大小
    ...
    //禁止名单报警信息
    public static class NET_VCA_BLOCKLIST_INFO_ALARM extends SdkStructure {
    ...
    //禁止名单比对结果报警上传
    public static class NET_VCA_FACESNAP_MATCH_ALARM extends SdkStructure {
        public int dwSize;             // 结构大小
    ...
    //交通事件报警(扩展)
    public static class NET_DVR_AID_ALARM_V41 extends SdkStructure {
        public int dwSize;              //结构长度
        public int dwRelativeTime;        //相对时标
        public int dwAbsTime;            //绝对时标
        public NET_VCA_DEV_INFO struDevInfo = new NET_VCA_DEV_INFO();            //前端设备信息
    ...
    //交通统计信息报警(扩展)
    public static class NET_DVR_TPS_ALARM_V41 extends SdkStructure {
        public int dwSize;          // 结构体大小
        public int dwRelativeTime;  // 相对时标
        public int dwAbsTime;       // 绝对时标
    ...
    public static class NET_DVR_LANE_PARAM_V41 extends SdkStructure {
    ...
    public static class NET_DVR_TPS_INFO_V41 extends SdkStructure {
    ...
    // 车道队列结构体
    public static class NET_DVR_LANE_QUEUE extends SdkStructure {
    ...
    //TPS统计过车数据上传
    public static class NET_DVR_TPS_STATISTICS_INFO extends SdkStructure {
        public int dwSize;          // 结构体大小
    ...
    // 交通参数统计信息
    public static class NET_DVR_TPS_STATISTICS_PARAM extends SdkStructure {
    ...
    //统计信息
    public static class NET_DVR_TPS_LANE_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_TIME_SEARCH_COND extends SdkStructure {
        public short wYear; //年
        public byte byMonth; //月
        public byte byDay; //日
        public byte byHour; //时
    ...
    //事件搜索条件
    public static class NET_DVR_SEARCH_EVENT_PARAM extends SdkStructure {
    ...
    //审讯事件搜索条件
    public static class EVENT_INQUESTPARAM extends SdkStructure {
    ...
    //事件搜索条件
    public static class NET_DVR_SEARCH_EVENT_PARAM_V50 extends SdkStructure {
        public short wMajorType;            //0-移动侦测，1-报警输入, 2-智能事件 5-pos录像 7-门禁事件, 8-非视频联动事件
        public short wMinorType;            //搜索次类型- 根据主类型变化，0xffff表示全部
    ...
    public static class EVENT_ALARMPARAM_V50 extends SdkStructure {
    ...
    //移动侦测
    public static class EVENT_MOTIONPARAM_V50 extends SdkStructure {
    ...
    //行为分析
    public static class EVENT_VCAPARAM_V50 extends SdkStructure {
    ...
    //审讯事件搜索条件
    public static class EVENT_INQUESTPARAM_V50 extends SdkStructure {
        public byte byRoomIndex;    //审讯室编号,从1开始
        public byte[] byRes = new byte[799];     //保留
    }

    //智能侦测查找条件 ，通道号按值表示
    public static class EVENT_VCADETECTPARAM_V50 extends SdkStructure {
    ...
    public static class EVENT_STREAMIDPARAM_V50 extends SdkStructure {
    ...
    //pos录像
    public static class EVENT_POSPARAM_V50 extends SdkStructure {
    ...
    public static class EVENT_TRIALPARAM_V50 extends SdkStructure {
    ...
    //门禁事件搜索条件
    public static class EVENT_ACSPARAM_V50 extends SdkStructure {
    ...
    //非视频联动事件搜索条件
    public static class EVENT_IOTPARAM_V50 extends SdkStructure {
    ...
    //查找返回结果
    public static class NET_DVR_SEARCH_EVENT_RET extends SdkStructure {
    ...
    //报警输入结果
    public static class EVENT_ALARMSTRET extends SdkStructure {
    ...
    //审讯事件
    public static class EVENT_INQUESTRET extends SdkStructure {
        public byte byRoomIndex;     //审讯室编号,从1开始
    ...
    //查找返回结果
    public static class NET_DVR_SEARCH_EVENT_RET_V50 extends SdkStructure {
        public short wMajorType;            //主类型
        public short wMinorType;            //次类型
    ...
    //报警输入结果
    public static class EVENT_ALARMRET_V50 extends SdkStructure {
        public int dwAlarmInNo;     //报警输入号
        public byte[] byRes = new byte[796];
    }

    //移动侦测结果
    public static class EVENT_MOTIONRET_V50 extends SdkStructure {
        public int dwMotDetNo;    //移动侦测通道
        public byte[] byRes = new byte[796];
    }

    //行为分析结果
    public static class EVENT_VCARET_V50 extends SdkStructure {
    ...
    //审讯事件
    public static class EVENT_INQUESTRET_V50 extends SdkStructure {
        public byte byRoomIndex;     //审讯室编号,从1开始
        public byte byDriveIndex;    //刻录机编号,从1开始
        public byte[] byRes1 = new byte[6];       //保留
        public int dwSegmentNo;     //本片断在本次审讯中的序号,从1开始
    ...
    //流id录像查询结果
    public static class EVENT_STREAMIDRET_V50 extends SdkStructure {
    ...
    //POS录像查询结果
    public static class EVENT_POSRET_V50 extends SdkStructure {
        public int dwChanNo;        //触发产生pos事件的通道
        public byte[] byRes = new byte[796];
    }

    public static class EVENT_TRIALRET_V50 extends SdkStructure {
        public byte byRoomIndex;     //审讯室编号,从1开始
        public byte byDriveIndex;    //刻录机编号,从1开始
        public short wSegmetSize;     //本片断的大小, 单位M
        public int dwSegmentNo;    //本片断在本次审讯中的序号,从1开始
    ...
    //非视频通道查询结果
    public static class EVENT_IOTRET_V50 extends SdkStructure {
        public int dwChanNo;        //触发产生事件的通道号（事件源通道）
        public byte[] byRes = new byte[796];
    }

    public static class NET_DVR_INQUEST_RESUME_SEGMENT extends SdkStructure {
    ...
    public static class NET_DVR_INQUEST_RESUME_EVENT extends SdkStructure {
    ...
    //报警信息查询条件结构体
    public static class NET_DVR_ALARM_SEARCH_COND extends SdkStructure {
        public int dwSize;
    ...
    //报警信息查询结果结构体
    public static class NET_DVR_ALARM_SEARCH_RESULT extends SdkStructure {
        public int dwSize;
        /*
  	报警命令，该字段值与报警布防类型相同，目前支持：
  	COMM_VCA_ALARM 	0x4993    智能检测报警
    ...
    public static class NET_DVR_ALARM_ISAPI_INFO extends SdkStructure {
    ...
    public static class NET_DVR_LOCAL_GENERAL_CFG extends SdkStructure {
    ...
    public static class NET_DVR_LOCAL_TCP_PORT_BIND_CFG extends SdkStructure {
    ...
    public static class NET_DVR_LOCAL_CHECK_DEV extends SdkStructure {
    ...
    public static class NET_DVR_ALARM_ISAPI_PICDATA extends SdkStructure {
        public int dwPicLen;
    ...
    public static class NET_DVR_FOCUSMODE_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_SERIALSTART_V40 extends SdkStructure {
        public int dwSize;         //结构体大小
    ...
    public static class NET_DVR_PRESET_NAME extends SdkStructure {
        public int dwSize;
    ...
    //Sensor信息
    public static class NET_DVR_SENSOR_PARAM extends SdkStructure {
    ...
    //球机位置信息
    public static class NET_DVR_PTZPOS_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_LLI_PARAM extends SdkStructure {
    ...
    //GIS信息上传
    public static class NET_DVR_GIS_UPLOADINFO extends SdkStructure {
        public int dwSize;//结构体大小
        public int dwRelativeTime; //相对时标
        public int dwAbsTime; //绝对时标
    ...
    public static class NET_DVR_DAYTIME extends SdkStructure {
    ...
    public static class NET_DVR_SCHEDULE_DAYTIME extends SdkStructure {
        public NET_DVR_DAYTIME struStartTime; //开始时间
        public NET_DVR_DAYTIME struStopTime; //结束时间
    }

    public static class NET_DVR_BUILTIN_SUPPLEMENTLIGHT extends SdkStructure {
        public int dwSize;//结构体大小
    ...
    public static class NET_DVR_HANDLEEXCEPTION_V41 extends SdkStructure {
        public int dwHandleType;        //异常处理,异常处理方式的"或"结果
        /*0x00: 无响应*/
        /*0x01: 监视器上警告*/
        /*0x02: 声音警告*/
    ...
    public static class NET_DVR_FACELIB_GUARD_COND extends SdkStructure {
        public int dwSize;
        public int dwChannel;  //通道号
    ...
    //导入人脸数据条件
    public static class NET_DVR_FACELIB_COND extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_SEND_PARAM_IN extends SdkStructure {
    ...
    public static class NET_DVR_INQUEST_ROOM extends SdkStructure {
        public byte byRoomIndex;     //审讯室编号
        public byte byFileType;        //0-审讯文件，1-开庭上传文件
        public byte[] byRes = new byte[22];       //保留
    }

    public static class NET_DVR_INQUEST_CDRW_CFG extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_INQUEST_CDRW_STATUS extends SdkStructure {
        /*运行状态：0-审讯开始，
     1-审讯过程中刻录，2-审讯停止，
     3-刻录审讯文件,
     4-备份(事后备份和本地备份)
    ...
    public static class NET_DVR_INQUEST_CDRW extends SdkStructure {
    ...
    //实时温度检测条件参数
    public static class NET_DVR_REALTIME_THERMOMETRY_COND extends SdkStructure {
        public int dwSize; /*结构体大小*/
    ...
    //点测温实时信息
    public static class NET_DVR_POINT_THERM_CFG extends SdkStructure {
    ...
    //框/线测温实时信息
    public static class NET_DVR_LINEPOLYGON_THERM_CFG extends SdkStructure {
    ...
    //实时温度信息
    public static class NET_DVR_THERMOMETRY_UPLOAD extends SdkStructure {
        public int dwSize; /* 结构体大小 */
        public int dwRelativeTime;
        public int dwAbsTime;
    ...
    public static class NET_PTZ_INFO extends SdkStructure {
        public float fPan;
        public float fTilt;
        public float fZoom;
    ...
    //测温模式配置
    public static class NET_DVR_THERMOMETRY_MODE extends SdkStructure {
        public int dwSize;//结构体大小
    ...
    public static class NET_DVR_THERMOMETRY_COND extends SdkStructure {
        public int dwSize;//结构体大小
        public int dwChannel;
    ...
    public static class NET_DVR_THERMOMETRY_PRESETINFO_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_THERMOMETRY_PRESETINFO extends SdkStructure {
        public int dwSize;//结构体大小
        public short wPresetNo;//0-保留
        public byte[] byRes = new byte[2];
    ...
    //温度报警（检测温度和配置温度比较报警）
    public static class NET_DVR_THERMOMETRY_ALARM extends SdkStructure {
        public int dwSize;
        public int dwChannel;//通道号
        public byte byRuleID;//规则ID
        public byte byThermometryUnit;//测温单位: 0-摄氏度（℃），1-华氏度（℉），2-开尔文(K)
    ...
    public static class NET_DVR_ARRAY_LIST extends SdkStructure {
        public int dwSize;     // 结构体大小
        public int dwCount;    // 阵列个数
        public NET_DVR_ARRAY_INFO[] struArrayInfo = new NET_DVR_ARRAY_INFO[SUPPORT_ARRAY_NUM];
    }

    public static class NET_DVR_BGA_INFO extends SdkStructure {
    ...
    // 阵列信息
    public static class NET_DVR_ARRAY_INFO extends SdkStructure {
    ...
    //物理磁盘
    public static class NET_DVR_PHY_DISK_INFO extends SdkStructure {
    ...
    public static class NET_DVR_WORKSTATE_V40 extends SdkStructure {
        public int dwSize;            //结构体大小
        public int dwDeviceStatic;      //设备的状态,0-正常,1-CPU占用率太高,超过85%,2-硬件错误,例如串口死掉
    ...
    public static class NET_DVR_GETWORKSTATE_COND extends SdkStructure {
    ...
    //多边型结构体
    public static class NET_ITC_POLYGON extends SdkStructure {
    ...
    public static class NET_ITC_PLATE_RECOG_REGION_PARAM extends SdkStructure {
    ...
    //单组IO测速参数
    public static class NET_ITC_SINGLE_IOSPEED_PARAM extends SdkStructure {
        public byte byEnable; //是否启用，0-不启用，1-启用
    ...
    //牌识参数
    public static class NET_ITC_PLATE_RECOG_PARAM extends SdkStructure {
    ...
    //卡口IO测速参数
    public static class NET_ITC_POST_IOSPEED_PARAM extends SdkStructure {
    ...
    public static class NET_DVR_GEOGLOCATION extends SdkStructure {
        public int[] iRes = new int[2]; /*保留*/
        public int dwCity; /*城市，详见PROVINCE_CITY_IDX */
    }

    public static class NET_ITC_INTERVAL_PARAM extends SdkStructure {
        public byte byIntervalType;    //间隔类型（默认按时间），0-时间起效,1-距离起效
        public byte[] byRes1 = new byte[3];
    ...
    public static class NET_ITC_VTLANE_PARAM extends SdkStructure {
        public byte byRelatedDriveWay;//关联的车道号
        public byte bySpeedCapEn; //是否启用超速抓拍，0-否，1-是
    ...
    public static class NET_ITC_VTCOIL_INFO extends SdkStructure {
    ...
    public static class NET_ITC_RADAR_PARAM extends SdkStructure {
    ...
    //卡口虚拟线圈触发参数
    public static class NET_ITC_POST_VTCOIL_PARAM extends SdkStructure {
    ...
    //车道属性参数结构
    public static class NET_ITC_LANE_LOGIC_PARAM extends SdkStructure {
        public byte byUseageType;     //车道用途类型，详见ITC_LANE_USEAGE_TYPE
    ...
    //视频电警线结构
    public static class NET_ITC_LINE extends SdkStructure {
        public NET_VCA_LINE struLine = new NET_VCA_LINE(); //线参数
        public byte byLineType; //线类型，详见ITC_LINE_TYPE
        public byte[] byRes = new byte[7];
    }

    public static class NET_ITC_SNAPMODE_PARAM extends SdkStructure {
    ...
    //size = 128
    public static class NET_ITC_HVT_EC_PARAM extends SdkStructure {
    ...
    public static class NET_ITC_LANE_HVT_PARAM extends SdkStructure {
    ...
    public static class NET_ITC_POST_HVT_PARAM extends SdkStructure {
    ...
    //抓拍机4.0新增
    public static class NET_ITC_LANE_HVT_PARAM_V50 extends SdkStructure {
    ...
    public static class NET_ITC_POST_HVT_PARAM_V50 extends SdkStructure {
        public byte byLaneNum;    //识别的车道个数，1-6
    ...
    public static class NET_ITC_LANE_PARAM extends SdkStructure {
    ...
    //卡口RS485车检器触发参数
    public static class NET_ITC_POST_RS485_PARAM extends SdkStructure {
        public byte byRelatedLaneNum;//关联的车道个数
    ...
    //卡口RS485雷达触发参数
    public static class NET_ITC_POST_RS485_RADAR_PARAM extends SdkStructure {
        public byte byRelatedLaneNum;//关联的车道个数
        public byte[] byRes1 = new byte[3];
        public NET_ITC_PLATE_RECOG_PARAM struPlateRecog = new NET_ITC_PLATE_RECOG_PARAM(); //牌识参数
        public NET_ITC_LANE_PARAM[] struLane = new NET_ITC_LANE_PARAM[MAX_ITC_LANE_NUM]; //关联的车道参数
...
//	public NET_ITC_REDLIGHT_PEDESTRIAN_PARAM struRedLightPed = new NET_ITC_REDLIGHT_PEDESTRIAN_PARAM();//行人闯红灯参数
    ...
    //单个触发参数结构
    public static class NET_ITC_SINGLE_TRIGGERCFG extends SdkStructure {
    ...
    //触发参数结构
    public static class NET_ITC_TRIGGERCFG extends SdkStructure {
        public int dwSize;            //结构长度
    ...
    //单个IO接入信号灯参数
    public static class NET_ITC_SINGLE_IO_LIGHT_PARAM extends SdkStructure {
    ...
    //IO接入信号灯参数
    public static class NET_ITC_IO_LIGHT_PARAM extends SdkStructure {
        public NET_ITC_SINGLE_IO_LIGHT_PARAM[] struIOLight = new NET_ITC_SINGLE_IO_LIGHT_PARAM[MAX_LIGHT_NUM]; //单个IO接入信号灯参数
        public byte[] byRes = new byte[8];
    }

    //单个485接入信号灯参数
    public static class NET_ITC_SINGLE_RS485_LIGHT_PARAM extends SdkStructure {
        public byte byLightType; //交通灯导向类型，0-左转灯，1-直行灯，2-右转灯
    ...
    //485接入信号灯参数
    public static class NET_ITC_RS485_LIGHT_PARAM extends SdkStructure {
        public NET_ITC_SINGLE_RS485_LIGHT_PARAM[] struRS485Light = new NET_ITC_SINGLE_RS485_LIGHT_PARAM[MAX_LIGHT_NUM]; //单个485接入信号灯参数
        public byte[] byRes = new byte[8];
    }

    public static class NET_POS_PARAM extends SdkStructure {
        public short wLeft;
        public short wTop;
        public short wRight;
    ...
    //单组视频检测交通信号灯参数结构
    public static class NET_ITC_SINGLE_VIDEO_DETECT_LIGHT_PARAM extends SdkStructure {
    ...
    public static class NET_ITC_VIDEO_DETECT_LIGHT_PARAM extends SdkStructure {
    ...
    //交通信号灯参数结构
    public static class NET_ITC_TRAFFIC_LIGHT_PARAM extends SdkStructure {
    ...
    //违规检测参数结构
    public static class NET_ITC_VIOLATION_DETECT_PARAM extends SdkStructure {
    ...
    //违规检测线参数结构
    public static class NET_ITC_VIOLATION_DETECT_LINE extends SdkStructure {
    ...
    //单个车道视频电警触发参数结构
    public static class NET_ITC_LANE_VIDEO_EPOLICE_PARAM extends SdkStructure {
    ...
    //视频电警触发参数结构
    public static class NET_ITC_VIDEO_EPOLICE_PARAM extends SdkStructure {
        public byte byEnable;    //是否启用，0-不启用，1-启用
    ...
    public static class NET_DVR_CURTRIGGERMODE extends SdkStructure {
        public int dwSize;
        public int dwTriggerType; //触发类型，详见ITC_TRIGGERMODE_TYPE
        public byte[] byRes = new byte[24];
    }

    public static class NET_ITC_VIDEO_TRIGGER_COND extends SdkStructure {
        public int dwSize;
        public int dwChannel;
    ...
    public static class NET_ITC_VIDEO_TRIGGER_PARAM extends SdkStructure {
        public int dwSize;
    ...
    public static class NET_DVR_CMS_PARAM extends SdkStructure {
        public int dwSize;
    ...
    //设置完全获取出厂值
    public static class NET_DVR_COMPLETE_RESTORE_INFO extends SdkStructure {
        public int dwSize; //结构体长度
        public int dwChannel; //通道号
        public byte[] byRes = new byte[64];
    }

    public static class NET_DVR_STD_ABILITY extends SdkStructure {
    ...
    public static class NET_DVR_STD_CONFIG extends SdkStructure {
    ...
    public static class NET_DVR_LOCAL_SDK_PATH extends SdkStructure {
        public byte[] sPath = new byte[NET_SDK_MAX_FILE_PATH];//组件库地址
        public byte[] byRes = new byte[128];
    }

    public static class BYTE_ARRAY extends SdkStructure {
        public byte[] byValue;
    ...
    public static class NET_DVR_JSON_DATA_CFG extends SdkStructure {
        public int dwSize;                        //结构体大小
    ...
    public static class CallBack_USER extends SdkStructure {
...
//2007-11-30 V211支持以下接口 //11
    ...
    //gps相关结构定义
    public static class TimeSegParam extends SdkStructure {
        //GPS数据查找起始时间
        public NET_DVR_TIME struBeginTime;
        //GPS数据查找结束时间
        public NET_DVR_TIME struEndTime;
    ...
    //按时间点查询
    public static class TimePointParam extends SdkStructure {
        //GPS数据查找时间点
    ...
    //gps查询参数定义
    public static class NET_DVR_GET_GPS_DATA_PARAM extends SdkStructure {
    ...
    //gps数据结构定义
    public static class NET_DVR_GPS_INFO extends SdkStructure {
    ...
    //gps返回数据结构定义
    public static class NET_DVR_GPS_DATA extends SdkStructure {
